...
const trackStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      false: "bg-surface-container-high forced-colors:bg-[ButtonBorder]",
      true: "bg-surface-container-low forced-colors:bg-[ButtonBorder]",
    },
  },
});
...
const fillStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      ...
      true: "bg-on-surface/20 forced-colors:bg-[GrayText]",
    },
  },
});
...
const thumbStyles = tv({
  extend: focusRing,
  base: "w-4.5 h-4.5 group-orientation-horizontal:mt-5 group-orientation-vertical:ml-2.5 rounded-full bg-surface border border-outline",
  variants: {
    isDragging: {
      true: "bg-primary forced-colors:bg-[ButtonBorder]",
    },
    isDisabled: {
      true: "border-on-surface/20 forced-colors:border-[GrayText]",
    },
  },
});
...
export function Slider<T extends number | number[]>({
  ...
  return (
    ...
    >
      <Label>{label}</Label>
      <SliderOutput className="text-sm text-on-surface-variant orientation-vertical:hidden">
