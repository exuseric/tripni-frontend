      ...
      {showArrow && (
        <OverlayArrow className="group">
          <svg
            ...
            height={12}
            viewBox="0 0 12 12"
            className="block fill-surface-container forced-colors:fill-[Canvas] stroke-1 stroke-outline-variant forced-colors:stroke-[ButtonBorder] group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90"
          >
