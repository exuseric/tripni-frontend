...
const trackStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      true: "bg-surface-container-high forced-colors:bg-[GrayText]",
    },
  },
});
...
export function ColorSlider({ label, ...props }: ColorSliderProps) {
  return (
    ...
    >
      <Label>{label}</Label>
      <SliderOutput className="text-sm text-on-surface-variant font-medium orientation-vertical:hidden" />
      <SliderTrack
