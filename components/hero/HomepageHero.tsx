...
const data = {
    ...
    description: "From the urban pulse of Nairobi to the serene shores of Watamu, Tripni is the first travel logger designed specifically for the Kenyan traveler.",
    cta: [
        {
    ...
    return (
        <header className="container container-grid py-container-block-sm md:py-container-block gap-y-12">
            <article className="col-span-full flex-center-col gap-y-3">
                <h1 className="font-display text-heading-medium text-primary capitalize md:text-heading-large max-w-[50ch] text-center">{data.title}</h1>
            ...
            <div className="col-span-full flex-center-col">
                <Image src={data.image} width={1000} height={1000} className="object-contain max-w-full max-h-[35rem]" alt="" priority />
            </div>
        </header>
    )
}
